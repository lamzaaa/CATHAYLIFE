...
const swiperInit = () => {
	...
	let benefit = new Swiper(".wrapper-benefit-list .swiper-container", {
		...
		observeParents: true,
		navigation: {
			nextEl: ".wrapper-benefit-list .swiper-container .swiper-button-next",
			prevEl: ".wrapper-benefit-list .swiper-container .swiper-button-prev",
		},
		breakpoints: {
			320: {
				slidesPerView: 1,
...
const faqList = function () {
	$(document).on("click", ".faq-list .title", function () {
...
/*====================Đăng ký tư vấn=================*/
function fakeImgtoVideo() {
	$(".advisory-desc .img").on("click", function (ev) {
		{
			$(this).addClass("active");
			$(this).find("img").addClass("active");
			$(this).find(".button").addClass("active");
			$(this).closest(".swiper-slide").addClass("active");
			$(this).find("iframe").addClass("active")[0].src +=
				"?rel=0&autoplay=1";
			ev.preventDefault();
		}
	});
